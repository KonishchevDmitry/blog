...
Наглядный пример: изменение `nr_huge_pages` + `surplus_huge_pages` + `free_huge_pages` [всегда производится под `hugetlb_lock`](https://github.com/torvalds/linux/blob/2942242dde896ea8544f321617c86f941899c544/mm/hugetlb.c#L3809), но вот при сборе статистики ядро [полагается исключительно на атомарное чтение отдельных `long`-переменных](https://github.com/torvalds/linux/blob/2942242dde896ea8544f321617c86f941899c544/mm/hugetlb.c#L5231).
